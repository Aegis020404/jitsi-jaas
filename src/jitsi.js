            ...
            754: (e, t, n) => {
                ...
                const o = new class extends r {
                    ...
                    serialize() {
                        ...
                        const t = this._storage.length, n = {};
                        for (let r = 0; r < t; r++) {
                ...
                function g(e) {
                    ...
                    if (!n.host) {
                        ...
                        if (t) {
                            const {host: e, hostname: i, pathname: s, port: o} = h(d(`org.jitsi.meet://${t}`));
                    ...
                    const {jwt: s, lang: o, release: a} = e, c = new URLSearchParams(n.search);
                    s && c.set("jwt", s);
                ...
                const m = {window: window.opener || window.parent}, f = "message";

                class v {
                    constructor() {
                        let {postisOptions: e} = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                        this.postis = function (e) {
                            var t, n = e.scope, r = e.window, i = e.windowForEventListening || window,
                                s = e.allowedOrigin, o = {}, a = [], c = {}, l = !1, d = "__ready__", u = function (e) {
                                    var t;
                                    try {
                                        t = JSON.parse(e.data)
                                    } catch (e) {
                                    ...
                                    if ((!s || e.origin === s) && t && t.postis && t.scope === n) {
                                        var r = o[t.method];
                                        if (r) for (var i = 0; i < r.length; i++) r[i].call(null, t.params); else c[t.method] = c[t.method] || [], c[t.method].push(t.params)
                                    }
                                };
                            ...
                            var h = {
                                listen: function (e, t) {
                                    o[e] = o[e] || [], o[e].push(t);
                                    var n = c[e];
                                    if (n) for (var r = o[e], i = 0; i < r.length; i++) for (var s = 0; s < n.length; s++) r[i].call(null, n[s]);
                                    delete c[e]
                                }, send: function (e) {
                                    var t = e.method;
                                    (l || e.method === d) && r && "function" == typeof r.postMessage ? r.postMessage(JSON.stringify({
                                        postis: !0,
                                        scope: n,
                                        method: t,
                                        params: e.params
                ...
                class b {
                    ...
                    _onMessageReceived(e) {
                        ...
                        } else e.type === y ? this.emit("request", e.data, ((t, n) => {
                ...
                (window.JitsiMeetJS || (window.JitsiMeetJS = {}), window.JitsiMeetJS.app || (window.JitsiMeetJS.app = {}), window.JitsiMeetJS.app).setExternalTransportBackend = e => undefined.setBackend(e);
                var w = n(860);
                ...
                const x = ["css/all.css", "libs/alwaysontop.min.js"], E = {
                ...
                class I extends (i()) {
                    constructor(e) {
                        ...
                        }(n), L = o.getItem("jitsiLocalStorage");
                        this._parentNode = c, this._url = function (e) {
                            return g({
                                ...arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                                url: `https://${e}/#jitsi_meet_external_api_id=${R}`
                            })
                        }(e, {
                            configOverwrite: l,
                            interfaceConfigOverwrite: d,
                            ...
                            release: w
                        }), this._createIFrame(a, s, p), this._transport = new b({
                            backend: new v({
                                postisOptions: {
                                    allowedOrigin: new URL(this._url).origin,
                                    scope: `jitsi_meet_external_api_${R}`,
                                    window: this._frame.contentWindow
                                }
                            })
                        }), Array.isArray(m) && m.length > 0 && this.invite(m), this._tmpE2EEKey = _, this._isLargeVideoVisible = !0, this._numberOfParticipants = 0, this._participants = {}, this._myUserID = void 0, this._onStageParticipant = void 0, this._setupListeners(), R++
                    }

                    _createIFrame(e, t, n) {
                        const r = `jitsiConferenceFrame${R}`;
                        ...
                        this._transport.on("event", (e => {
                            ...
                            switch (t) {
                                case"video-conference-joined":
                                    void 0 !== this._tmpE2EEKey && (this.executeCommand(E.e2eeKey, this._tmpE2EEKey), this._tmpE2EEKey = void 0), this._myUserID = r, this._participants[r] = {avatarURL: n.avatarURL};
                                case"participant-joined":
                                    this._participants[r] = this._participants[r] || {}, this._participants[r].displayName = n.displayName, this._participants[r].formattedDisplayName = n.formattedDisplayName, O(this, 1);
                                    break;
                                case"participant-left":
                                    O(this, -1), delete this._participants[r];
                                    break;
                    ...
                    async setMediaEncryptionKey(e) {
                        ...
                        } else this.executeCommand("setMediaEncryptionKey", JSON.stringify({exportedKey: !1, index: n}))
                    }
                }
            }, 872: (e, t, n) => {
                ...
                function s() {
                    ...
                    if (!(t[s] < e.level)) for (var a = !(e.options.disableCallerInfo || r.disableCallerInfo) && i(), c = n.concat(e.transports), l = 0; l < c.length; l++) {
                        var d = c[l], u = d[s];
                ...
                function o(e, n, r, i) {
                    this.id = n, this.options = i || {}, this.transports = r, this.transports || (this.transports = []), this.level = t[e];
                ...
                var r = n(7), i = n(369), s = {}, o = [], a = r.levels.TRACE;
                e.exports = {
                    ...
                    try {
                        ...
                        try {
                            await async function (e) {
                                ...
                                const r = window.getSelection(), i = window.document.createRange();
                ...
                e.exports = s, e.exports.once = function (e, t) {
                    return new Promise((function (n, r) {
                        ...
                        m(e, t, s, {once: !0}), "error" !== t && function (e, t, n) {
                ...
                function l(e, t, n, r) {
                    var i, s, o, l;
                    if (a(n), void 0 === (s = e._events) ? (s = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== s.newListener && (e.emit("newListener", t, n.listener ? n.listener : n), s = e._events), o = s[t]), void 0 === o) o = s[t] = n, ++e._eventsCount; else if ("function" == typeof o ? o = s[t] = r ? [n, o] : [o, n] : r ? o.unshift(n) : o.push(n), (i = c(e)) > 0 && o.length > i && !o.warned) {
                        o.warned = !0;
